...
export default async function handler(req, res) {
    ...
    try {
        ...
        // NO DEMO DATA - Return empty response instead
        return res.status(200).json({
            success: false,
            total_games: 0,
            games: [],
            ...
            api_calls_made: 0,
            sports_processed: 0,
            message: 'לא נמצאו משחקים - בדוק חיבור לאינטרנט',
...
async function fetchAllLeaguesData() {
    ...
    // If no games, return empty instead of demo data
    if (allGames.length === 0) {
        ...
        return {
            ...
            message: 'לא נמצאו משחקים זמינים מה-API',
